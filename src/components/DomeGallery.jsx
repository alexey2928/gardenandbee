    ...
    const ro = new ResizeObserver((entries) => {
      ...
      if (enlargedOverlay && frameRef.current && mainRef.current) {
        ...
        if (hasCustomSize) {
          ...
          tempDiv.style.cssText = `position: absolute; width: ${openedImageWidth}; height: ${openedImageHeight}; max-width: 400px; max-height: 400px; visibility: hidden;`;
